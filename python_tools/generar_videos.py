...
# Lista de las 9 clases del modelo Edge Impulse (orden alfabético del entrenamiento)
# Las 8 primeras son caídas (fall_*), la 9 restante es actividad normal
CLASS_LIST = [
...
CLASS_TRANSLATIONS = {
    ...
    "fall_bending": "Caída agachándose",
...
# Índices 0 a 7 son caídas (fall_*), 8 es actividad normal
...
def generar_video_predicciones(data, output_path):
    ...
    ax.set_yticklabels(translated_labels, color='#E0E0E0', fontsize=8)
    ax.tick_params(colors='#E0E0E0')

    ax.set_title("Línea de Tiempo - Edge Impulse (9 Clases)", color='#FFFFFF', fontsize=12, fontweight='bold', pad=15)
    ...
    def update(frame):
        ...
        for p in current_predictions:
            ...
            if class_name in CLASS_LIST:
                ...
                # En Edge Impulse 9 clases, los índices 0-7 son caídas (fall_*)
...
def generar_video_acelerometro(data, output_path):
    ...
    ax.set_title("Datos del Acelerómetro — Edge Impulse 9", color='#FFFFFF', fontsize=12, fontweight='bold', pad=15)
    ax.set_xlabel("Tiempo (segundos)", color='#E0E0E0', fontsize=10, labelpad=10)
